**Validation gate: PASS.** January's calculated median is 15.03957 weeks, compared with the official 15.0 weeks: a difference of 0.03957 weeks, inside the required 0.1-week tolerance. The later workbook comparisons below also pass.
...
At the end of May 2026, half of the waiting pathways had been open for roughly **12.4 weeks or less**. Yet the wait that included **92%** of the list was **38.6 weeks**. This is the **92nd percentile**, or **p92**: the point below which that share of waiting pathways sits.

The standard requires at least 92% of incomplete pathways to be within 18 weeks. On the grouped-data estimate, the gap was therefore **20.6 weeks**. This is a description of how long the current list has been waiting so far. It is not a prediction of the wait faced by a new referral or the time remaining before treatment.

Both the median and p92 fell between the start and end of this submitted-data series. Reporting gaps mean this is not a fully constant provider population. The median fell by **2.6 weeks**, while p92 fell by **6.7 weeks**. Improvement and a missed standard coexist. A median inside eighteen weeks does not establish that patients are fine, or that the standard is being met: the standard protects far more than the middle patient.

## The official comparison

| Month | Official median (weeks, published precision) | Computed median (weeks) | Difference (weeks) | Method note |
| --- | --- | --- | --- | --- |
| 2024-01 | 15.0 | 15.03957 | +0.03957 | Publication rounded to one decimal; same linear band estimate |
| 2025-02 | 14.2 | 14.20786 | +0.00786 | Publication rounded to one decimal; same linear band estimate |
| 2026-04 | 11.9 | 11.89565 | -0.00435 | Publication rounded to one decimal; same linear band estimate |
| 2026-05 | 12.4 | 12.42282 | +0.02282 | Publication rounded to one decimal; same linear band estimate |
...
| Measure | January 2024 | May 2026 |
| --- | --- | --- |
| Pathways still waiting | 7,575,914 | 7,153,655 |
| Median: half of pathways within this wait | 15.0 weeks | 12.4 weeks |
| p75: three quarters within this wait | 28.5 weeks | 23.9 weeks |
| p92: 92% within this wait | 45.3 weeks | 38.6 weeks |
| p95: 95% within this wait | 50.4 weeks | 43.4 weeks |
| p92 minus the 18-week threshold | 27.3 weeks | 20.6 weeks |
| Share within 18 weeks | 57.0% | 65.6% |
...
![The national median over time](../figures/figure-01-median.png)

![The median and p92 compared with eighteen weeks](../figures/figure-02-promise.png)

## The middle is substantial, but it is not the largest group

The middle means pathways open for **more than eighteen and no more than fifty-two weeks**. At the end of May 2026 it contained **2,361,713 pathways**, **33.0%** of the list. The extracts cannot tell us how many unique people those pathways represent.

| Waiting so far | January 2024: pathways / share | May 2026: pathways / share | Change in count |
| --- | --- | --- | --- |
| Within 18 weeks | 4,321,271 / 57.0% | 4,689,601 / 65.6% | +368,330 |
| Over 18, up to 52 weeks | 2,933,249 / 38.7% | 2,361,713 / 33.0% | -571,536 |
| Over 52 weeks | 321,394 / 4.2% | 102,341 / 1.4% | -219,053 |

The middle fell by **571,536 pathways** across all specialties, and its share fell by **5.7 percentage points**. Across the seven named specialties alone, it fell by **246,987**, reproducing Finding 02. The all-specialty reduction therefore extends that finding; it is not the same cohort total.
...
![The three waiting groups as pathway counts](../figures/figure-03-middle.png)
...
| Specialty (code) | Median (weeks) | p92 (weeks) | Gap from 18 (weeks) | Middle: pathways / share |
| --- | --- | --- | --- | --- |
| General surgery (C_100) | 13.3 | 40.9 | 22.9 | 135,174 / 35.4% |
| Trauma and orthopaedics (C_110) | 14.1 | 41.8 | 23.8 | 312,261 / 37.7% |
| ENT (C_120) | 14.8 | 41.6 | 23.6 | 231,502 / 39.0% |
| Ophthalmology (C_130) | 10.2 | 33.4 | 15.4 | 157,081 / 25.2% |
| Gastroenterology (C_301) | 11.8 | 36.1 | 18.1 | 111,247 / 30.1% |
| Cardiology (C_320) | 12.1 | 35.5 | 17.5 | 117,103 / 30.9% |
| Neurology (C_400) | 14.0 | 38.9 | 20.9 | 78,654 / 37.9% |
...
| Month | Completed pathways, England all specialties | Known-wait pathways | Median (weeks) | p92 (weeks) |
| --- | --- | --- | --- | --- |
| 2025-02 | Admitted | 310,349 | 12.2 | 55.9 |
| 2025-02 | Non-admitted | 1,147,295 | 9.8 | 48.9 |
| 2026-04 | Admitted | 287,231 | 13.1 | 52.1 |
| 2026-04 | Non-admitted | 1,159,840 | 8.8 | 44.2 |
...
**February 2019 baseline, reported incomplete pathways, England, all specialties once, `NONC` excluded, no missing-provider estimates:** the reconstructed median is **6.7 weeks** and p92 is **22.1 weeks**. The historical file has fifty-two closed weekly bands and one open band beyond fifty-two weeks. Both percentiles fall in closed bands, so both are computable. We did not assign an invented width to the final band.
...
![The latest month's full band distribution](../figures/figure-04-shape.png)
